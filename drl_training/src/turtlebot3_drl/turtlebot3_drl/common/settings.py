...
BETA_ANGULAR               = 0.05  # coefficient for the -(beta * angular_velocity^2) motion penalty
OBSTACLE_PROXIMITY_DIST    = 0.35  # meters; soft reward penalty when an obstacle is closer than this
...
# SAC parameters
SAC_ALPHA               = 0.2   # Initial entropy temperature
SAC_ALPHA_LR            = 3e-4  # Learning rate for alpha optimizer
LEARNABLE_TEMPERATURE   = True  # Auto-tune entropy temperature
