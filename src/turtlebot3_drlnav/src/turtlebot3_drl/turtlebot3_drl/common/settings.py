...
GAZEBO_HARMONIC          = True     # Gazebo Harmonic has no /pause_physics service — skip pause/unpause
...
EPISODE_TIMEOUT_SECONDS     = 50    # Number of seconds after which episode timeout occurs
ARENA_LENGTH                = 4.2   # meters (creator's stage worlds)
ARENA_WIDTH                 = 4.2   # meters
SPEED_LINEAR_MAX            = 0.50  # SCUTTLE max linear velocity (m/s) — was 0.22 for burger
SPEED_ANGULAR_MAX           = 1.0   # SCUTTLE max angular velocity (rad/s) — was 2.0 for burger

LIDAR_DISTANCE_CAP          = 3.5   # meters
THRESHOLD_COLLISION         = 0.20  # SCUTTLE: wider chassis than burger (0.315 m wheelbase)
...
REAL_N_SCAN_SAMPLES         = 360   # LD19 T-Mini Plus: full 360° at 360 samples

REAL_ARENA_LENGTH           = 4.2   # meters
REAL_ARENA_WIDTH            = 4.2   # meters
REAL_SPEED_LINEAR_MAX       = 0.50  # SCUTTLE max linear velocity (m/s)
REAL_SPEED_ANGULAR_MAX      = 1.0   # SCUTTLE max angular velocity (rad/s)
